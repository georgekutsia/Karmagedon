class Score {
  ...
  draw() {
    ...
    this.ctx.fillStyle = "white";
    ctx.fillRect(1235, 615, 150, 25);
    this.ctx.fillStyle = "black";
    this.ctx.font = "21px Arco";
    this.ctx.fillText(`Total solved: ${solvedTotal.toString()}`, 1240, 635);
    ...
    if(hookBoost || !machinegunBoost || elementBoost){
        ...
        this.ctx.fillText(`Special Weapons`, 1234, 680);
        this.ctx.font = "15px Arial";
      }
    if(solvedTotal <= 19){
      this.ctx.fillStyle = "orange";
      this.ctx.fillText(`Supervisor`, 1242, 370);
      this.ctx.fillStyle = "white";
    ...
    this.ctx.fillText(`Budget ${money}$`, 1228, 395);
  }

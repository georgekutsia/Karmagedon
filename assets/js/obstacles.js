class Puddle{
  constructor(ctx) {
    ...
    this.puddle.src = "https://res.cloudinary.com/dfrda73uc/image/upload/v1688381942/karengedon/elements/puddleCanvas_mpf3c0.png";
    this.worning = new Image();
    this.worning.src = "https://res.cloudinary.com/dfrda73uc/image/upload/v1688381756/karengedon/elements/excla_tairj1.png"
    this.puff = new Image();
    this.puff.src = "https://res.cloudinary.com/dfrda73uc/image/upload/v1688381734/karengedon/elements/Puff1_gid7cz.png"
    this.bla = 20
    this.blu = 30
    this.puddle.frame = 0;
    this.puff.frame = 0;
...
class Fire{
  constructor(ctx) {
    ...
    this.h = 25;
    this.fire = new Image();
    this.fire.src = "https://res.cloudinary.com/dfrda73uc/image/upload/v1688381739/karengedon/elements/flames_ldbnv2.png";
    this.worning = new Image();
    this.worning.src = "https://res.cloudinary.com/dfrda73uc/image/upload/v1688381756/karengedon/elements/excla_tairj1.png"
    this.puff = new Image();
    this.puff.src = "https://res.cloudinary.com/dfrda73uc/image/upload/v1688381734/karengedon/elements/Puff1_gid7cz.png"
